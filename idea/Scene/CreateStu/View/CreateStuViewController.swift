...
//        $0.addTarget(self, action: #selector(signUpBtnDidTap), for: .touchUpInside)
    ...
    override func addView() {
        [titleTextField,titleTextFieldLine,explainTextView,selectDateBtn,feBtn,beBtn,iosBtn,aosBtn,etcBtn,makeBtn].forEach{
            view.addSubview($0)
        }
    }
    ...
    override func setLayout() {
        ...
        feBtn.snp.makeConstraints {
            $0.top.equalTo(selectDateBtn.snp.bottom).offset(24)
